...
function initBuffers() {
  ...
  var colors = [
    [1.0,  1.0,  1.0,  1.0],    // Front face: cyan
...
function initWebGL(canvas) {
  ...
  try {
    ...
    var pars = {premultipliedAlpha: false, alpha: false};
...
function start() {
  ...
  if (gl) {
    ...
    gl.enable(gl_options);                               // Enable depth testing
...
function drawScene() {
  ...
  setMatrixUniforms();
  // gl.drawArrays(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 0);
  // gl.pointSize();
  // gl.lineWidth();
  gl.lineWidth(9);
